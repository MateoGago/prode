/**
 * Pure domain types for the fixtures feature.
 * No infra/framework imports — these types are the heart of the domain.
 */
 ...
 * Carries only what calcularPuntos() needs — no UI concerns.
 */
